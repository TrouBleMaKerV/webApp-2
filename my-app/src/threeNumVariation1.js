...
class threeNumVariation1 extends Component {
    constructor(props) {
        super(props);
        this.state = {
            columns: [
                {
                    ...
                    render: (row, column,index)=> {
                        if (
                            ...
                            this.state.result[1] != null && this.state.result[1].one.indexOf(index) != -1
                        ){
                            return <span><Tag type="warning">{this.state.data[index].one}</Tag></span>
                        }else if(
                            this.state.result[2] != null && this.state.result[2].one.indexOf(index) != -1
                        ){
                            return <span><Tag type="success">{this.state.data[index].one}</Tag></span>
                        }else if(
                            this.state.result[3] != null && this.state.result[3].one.indexOf(index) != -1
                        ){
                            return <span><Tag type="danger">{this.state.data[index].one}</Tag></span>
                        }
                        else if(
                            this.state.result[4] != null && this.state.result[4].one.indexOf(index) != -1
                        ){
                            return <span><Tag type="gray">{this.state.data[index].one}</Tag></span>
                        }
                        else if(
                            this.state.result[5] != null && this.state.result[5].one.indexOf(index) != -1
                        ){
                ...
                },
                {
                    ...
                    render: (row, column,index)=>{
                        if (
                            ...
                            this.state.result[1] != null && this.state.result[1].two.indexOf(index) != -1
                        ){
                            return <span><Tag type="warning">{this.state.data[index].two}</Tag></span>
                        }else if(
                            this.state.result[2] != null && this.state.result[2].two.indexOf(index) != -1
                        ){
                            return <span><Tag type="success">{this.state.data[index].two}</Tag></span>
                        }else if(
                            this.state.result[3] != null && this.state.result[3].two.indexOf(index) != -1
                        ){
                            return <span><Tag type="danger">{this.state.data[index].two}</Tag></span>
                        }
                        else if(
                            this.state.result[4] != null && this.state.result[4].two.indexOf(index) != -1
                        ){
                            return <span><Tag type="gray">{this.state.data[index].two}</Tag></span>
                        }
                        else if(
                            this.state.result[5] != null && this.state.result[5].two.indexOf(index) != -1
                        ){
                ...
                },
                {
                    ...
                    render: (row, column,index)=>{
                        if (
                            ...
                            this.state.result[1] != null && this.state.result[1].three.indexOf(index) != -1
                        ){
                            return <span><Tag type="warning">{this.state.data[index].three}</Tag></span>
                        }else if(
                            this.state.result[2] != null && this.state.result[2].three.indexOf(index) != -1
                        ){
                            return <span><Tag type="success">{this.state.data[index].three}</Tag></span>
                        }else if(
                            this.state.result[3] != null && this.state.result[3].three.indexOf(index) != -1
                        ){
                            return <span><Tag type="danger">{this.state.data[index].three}</Tag></span>
                        }
                        else if(
                            this.state.result[4] != null && this.state.result[4].three.indexOf(index) != -1
                        ){
                            return <span><Tag type="gray">{this.state.data[index].three}</Tag></span>
                        }
                        else if(
                            this.state.result[5] != null && this.state.result[5].three.indexOf(index) != -1
                        ){
                ...
                },
                {
                    ...
                    render: (row, column,index)=>{
                        if(index % 4 == 3){
                            return <span><Tag type="danger">{this.state.data[index].one + this.state.data[index].two + this.state.data[index].three+ this.state.data[index].four}</Tag></span>
                        }else{
    ...
    componentWillMount(){
        ...
        axios.get(`http://47.94.86.217//getThreeNumVariation`,{
            params:{
                a: "one",
                b: "two",
                c: "three"
...
export default threeNumVariation1;